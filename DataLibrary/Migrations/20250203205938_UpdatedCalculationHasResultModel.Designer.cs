...
namespace DataLibrary.Migrations
{
    ...
    [Migration("20250203205938_UpdatedCalculationHasResultModel")]
    partial class UpdatedCalculationHasResultModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataLibrary.Models.CalculationHasFeedEntity", b =>
                {
                    ...
                    b.Property<int?>("CalculationHasResultEntityId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("CalculationHasResultEntityId");
            ...
            modelBuilder.Entity("DataLibrary.Models.CalculationHasResultEntity", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("CalculationHasFeedIds")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DataLibrary.Models.FeedTranslationEntity", b =>
                {
                    ...
                    b.HasKey("FeedId", "LanguageCode");

                    b.HasIndex("FeedId", "LanguageCode");
            ...
            modelBuilder.Entity("DataLibrary.Models.SpeciesTranslationEntity", b =>
                {
                    ...
                    b.HasKey("SpeciesId", "LanguageCode");
            ...
            modelBuilder.Entity("DataLibrary.Models.CalculationHasFeedEntity", b =>
                {
                    b.HasOne("DataLibrary.Models.CalculationHasResultEntity", null)
                        .WithMany("CalculationHasFeedList")
                        .HasForeignKey("CalculationHasResultEntityId");
            ...
            modelBuilder.Entity("DataLibrary.Models.CalculationHasResultEntity", b =>
                {
                    b.Navigation("CalculationHasFeedList");
                });
