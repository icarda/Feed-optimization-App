...
namespace DataLibrary.Migrations
{
    ...
    [Migration("20250122193816_UpdatedIdPropertiesToHaveIntDatatypes")]
    partial class UpdatedIdPropertiesToHaveIntDatatypes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataLibrary.Models.CalculationHasFeedEntity", b =>
                {
                    ...
                    b.HasKey("CalculationId", "FeedId");

                    b.HasIndex("FeedId");

                    b.HasIndex("CalculationId", "FeedId");
            ...
            modelBuilder.Entity("DataLibrary.Models.CountryTranslationEntity", b =>
                {
                    ...
                    b.ToTable("CountryTranslations", "dbo");
                });
            ...
            modelBuilder.Entity("DataLibrary.Models.FeedTranslationEntity", b =>
                {
                    ...
                    b.ToTable("FeedTranslations", "dbo");
                });
            ...
            modelBuilder.Entity("DataLibrary.Models.LabelTranslationEntity", b =>
                {
                    ...
                    b.ToTable("LabelTranslations", "dbo");
                });
            ...
            modelBuilder.Entity("DataLibrary.Models.SpeciesTranslationEntity", b =>
                {
                    ...
                    b.ToTable("SpeciesTranslations", "dbo");
                });
